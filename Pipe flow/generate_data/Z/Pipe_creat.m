...
model.modelPath('D:\yangbo\2024-paper\paper\NS\comosl_batch_UZ\U');
...
pout = [dx1+dx3+1e-5 dx1+dx3-1e-5; dy1-dy2-dy3 dy1-dy2];  % 出口附近一点（负 y 一侧给个点）
...
vtu = ['C:\Users\DELL\Downloads\NS_revision\Z_skewing\Z_dataset\Pipe_ns_' num2str(data_id) '.vtu'];
