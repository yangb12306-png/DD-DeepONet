...
for data_id in range(1, 10101):
    ...
    # save data
    SaveData(f'/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_skewing/Geo/Geo_{data_id}.csv', 
              proxy=threshold1, 
    ...
    # save data
    SaveData(f'/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_skewing/BC/_BC_{data_id}.csv', 
              proxy=featureEdges1, 
              PointDataArrays=['U', 'X', 'Y', '压力', '速度场，x_分量', '速度场，y_分量'],
              Precision=6)
