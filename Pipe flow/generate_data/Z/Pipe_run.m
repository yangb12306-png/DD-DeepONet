...
% 
% % 生成 U0，范围 [0.1, 0.25]，保留两位小数
% U0 = round(0.1 + (0.25 - 0.1) * rand(num_samples, 1), 2);
% 
...
% 
% % 打开文件
% fileID = fopen('data_skewing_10100.txt', 'w');
% 
% % 写入数据
% for i = 1:num_samples
...
% 
% % 保存不收敛样本的 data_id
% save('non_convergence_skewing_Z.mat', 'non_convergence');
% 
...
% 不收敛的 722, 785, 1381, 1419, 1726, 1739, 2056, 2821, 2984; 
% 在data_pipe.txt中删除该行对应的数据，但是在计算后处理数据的时候，需要取出对应的几何参数。使用原始的数据最好
% 代码运行时间：15876.170000s

% 10100：
% 代码运行时间: 50560.471000 秒
% 不收敛：48 618 1249 1751 2329 2363 2482 2551 2876 2998 3297 3299 3355 3807 3991 4047 4468
% 4565 4888 5250 5357 5826 6193 6220 6406 6448 6904 6947 7000 7031 7212 8462 8486 8754
% 9238 9373 9539 9630 9698

% 50000
% 代码运行时间: 274993.363000 秒

% Z_skewing: 10100 (27个不收敛)
% 代码运行时间: 50937.307000 秒


%% 将data.txt中不收敛的行去掉
data = load('data_skewing_10100.txt');
non_convergence = load('non_convergence_skewing_Z.mat');
...
% 5. 可选：保存处理后的数据
writematrix(filtered_data, 'data_skewing_10073.txt', 'Delimiter', 'tab');
