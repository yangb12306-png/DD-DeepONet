...
Drichlet_value = np.loadtxt('/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/Dirichlet_2and3and4.txt')

input_folder_Geo = '/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/Geo'
input_folder_BC = '/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/BC'

# 列名（如果读取时指定）
column_names = ['u', 'v', 'U', 'p', 'X', 'Y', 'Points_0', 'Points_1', 'Points_2']

out_pkl_path = '/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/NS_U_skewing.pkl'
