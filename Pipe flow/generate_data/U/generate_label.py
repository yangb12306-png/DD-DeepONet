...
# # 设置路径
# output_path = '/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/label_part23.txt'
# input_folder = '/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/temp'
...
# Dirichlet_path = '/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/Dirichlet_3and4.txt'
...
#     # 生成文件路径
#     IP_file = f'/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/temp/part3And4_bc_IP_{data_id}.csv'
