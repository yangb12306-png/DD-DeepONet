...
start = time.time()
# load data
data_file = f"{DATA_FILEBASE}/NS/inference/U_test.pkl"
...
data_file = f"{DATA_FILEBASE}/NS/inference/TC_xyt_U.pkl"
with open(data_file, "rb") as f:
    data = pickle.load(f)
...
filename_domain_1 = '/data2/yangbo/GINOT/GINOT-main/U/part1.txt'
filename_domain_2 = '/data2/yangbo/GINOT/GINOT-main/U/part2.txt'
...
#############################################################################
    ...
    save_ragged_1d_txt("/data2/yangbo/GINOT/GINOT-main/U/part3_pred.txt", domain_3_result, sep=" ", fmt="%.8f")
    save_ragged_1d_txt("/data2/yangbo/GINOT/GINOT-main/U/part3_true.txt", true_3, sep=" ", fmt="%.8f")
