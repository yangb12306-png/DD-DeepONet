...
# pred
pred_part1 = np.loadtxt("/data2/yangbo/GINOT/GINOT-main/U/part1.txt")
pred_part2 = np.loadtxt("/data2/yangbo/GINOT/GINOT-main/U/part2.txt")
...
true_part3 = load_ragged_1d_txt("/data2/yangbo/GINOT/GINOT-main/U/part3_true.txt")
pred_part3 = load_ragged_1d_txt("/data2/yangbo/GINOT/GINOT-main/U/part3_pred.txt")
