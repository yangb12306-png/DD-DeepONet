...
# pred
pred_part1 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_UZU/batch_2000/part1.txt")
pred_part2 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_UZU/batch_2000/part2.txt")
pred_part3 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_UZU/batch_2000/part3.txt")
pred_part4 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_UZU/batch_2000/part4.txt")
pred_part5 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_UZU/batch_2000/part5.txt")
print(pred_part1.shape)
pred_part1 = pred_part1[0:96, :]
pred_part2 = pred_part2[0:96, :]
pred_part3 = pred_part3[0:96, :]
pred_part4 = pred_part4[0:96, :]
pred_part5 = pred_part5[0:96, :]
print(pred_part1.shape)
