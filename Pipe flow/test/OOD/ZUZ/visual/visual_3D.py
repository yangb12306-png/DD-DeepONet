...
# pred
pred_part1 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch/part1.txt")
pred_part2 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch/part2.txt")
pred_part3 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch/part3.txt")
pred_part4 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch/part4.txt")
pred_part5 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch/part5.txt")
...
x_coords = dx1 + dx3 + dx4 - i * ((dx3 + dx4) / (x_points_num - 1))
...
i, j = np.mgrid[0:x_points_num, 0:y_points_num]
i, j = i.ravel(), j.ravel()  # 矢量化索引
x_coords = (dx1 + dx3) + i * (dx4 / (x_points_num - 1))
y_coords = dy1 - dy2 - dy3 + dy4 + dy5 - j * ((dy4 + dy5) / (y_points_num - 1))
...
i, j = np.mgrid[0:x_points_num, 0:y_points_num]
i, j = i.ravel(order="F"), j.ravel(order="F")  # 矢量化索引
x_coords = (dx1 + dx3 + dx5) - i * (dx5 / (x_points_num - 1))
y_coords = dy1 - dy2 - dy3 + dy4 + j * (dy5 / (y_points_num - 1))
...
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/true_part1_{data_id}.vtk', trunk_part1, true_part1, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/pred_part1_{data_id}.vtk', trunk_part1, pred_part1, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/error_part1_{data_id}.vtk', trunk_part1, error_part1, precision=8)

write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/true_part2_{data_id}.vtk', trunk_part2, true_part2, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/pred_part2_{data_id}.vtk', trunk_part2, pred_part2, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/error_part2_{data_id}.vtk', trunk_part2, error_part2, precision=8)

write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/true_part3_{data_id}.vtk', trunk_part3, true_part3, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/pred_part3_{data_id}.vtk', trunk_part3, pred_part3, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/error_part3_{data_id}.vtk', trunk_part3, error_part3, precision=8)

write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/true_part4_{data_id}.vtk', trunk_part4, true_part4, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/pred_part4_{data_id}.vtk', trunk_part4, pred_part4, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/error_part4_{data_id}.vtk', trunk_part4, error_part4, precision=8)

write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/true_part5_{data_id}.vtk', trunk_part5, true_part5, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/pred_part5_{data_id}.vtk', trunk_part5, pred_part5, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/visual/vtk/error_part5_{data_id}.vtk', trunk_part5, error_part5, precision=8)
