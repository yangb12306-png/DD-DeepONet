...
filename_domain_1 = '/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch_2000/part1.txt'
filename_domain_2 = '/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch_2000/part2.txt'
filename_domain_3 = '/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch_2000/part3.txt'
filename_domain_4 = '/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch_2000/part4.txt'
filename_domain_5 = '/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_23_ZUZ/batch_2000/part5.txt'
...
with open(filename_domain_1, 'w') as f_1, open(filename_domain_2, 'w') as f_2, open(filename_domain_3, 'w') as f_3, \
    ...
    while  iteration < Iter:
        ...
        part3_branch2 = domain_Z_net((domain_2_branch_1, domain_2_branch_2, domain_2_branch_3, domain_2_branch_4, coord_part2_out)) # part2中计算
        ...
        domain_3_branch_2 = domain_3_branch_2.flip(dims=[1])
        domain_3_branch_2[:, [0, -1]] = 0

        part3_branch3 = domain_Z_net((domain_4_branch_1, domain_4_branch_2, domain_4_branch_3, domain_4_branch_4, coord_part4_in)) # part4中计算
        ...
        # update, part 3
        part2_branch3 = domain_U_net((domain_3_branch_1, domain_3_branch_2, domain_3_branch_3, domain_3_branch_4, coord_part3_in)) # part3中计算
        ...
        part4_branch2 = domain_U_net((domain_3_branch_1, domain_3_branch_2, domain_3_branch_3, domain_3_branch_4, coord_part3_out)) # part3中计算
        ...
        # update, part 2 and 4
        part1_branch3 = domain_Z_net((domain_2_branch_1, domain_2_branch_2, domain_2_branch_3, domain_2_branch_4, coord_part2_in)) # part2中计算
        ...
        part5_branch2 = domain_Z_net((domain_4_branch_1, domain_4_branch_2, domain_4_branch_3, domain_4_branch_4, coord_part4_out)) # part4中计算
        ...
        domain_5_branch_2_temp = domain_5_branch_2_temp.flip(dims=[1])
