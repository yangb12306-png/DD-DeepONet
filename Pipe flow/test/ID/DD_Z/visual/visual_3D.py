...
true_part3 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_train_10100/label_part4.txt")
...
# pred
pred_part1 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/batch/both/part1.txt")
pred_part2 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/batch/both/part2.txt")
pred_part3 = np.loadtxt("/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/batch/both/part3.txt")
...
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/true_part1_{data_id}.vtk', trunk_part1, true_part1, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/pred_part1_{data_id}.vtk', trunk_part1, pred_part1, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/error_part1_{data_id}.vtk', trunk_part1, error_part1, precision=8)

write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/true_part2_{data_id}.vtk', trunk_part2, true_part2, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/pred_part2_{data_id}.vtk', trunk_part2, pred_part2, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/error_part2_{data_id}.vtk', trunk_part2, error_part2, precision=8)

write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/true_part3_{data_id}.vtk', trunk_part3, true_part3, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/pred_part3_{data_id}.vtk', trunk_part3, pred_part3, precision=8)
write_vtk(f'/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/DD_Z/visual/vtk/error_part3_{data_id}.vtk', trunk_part3, error_part3, precision=8)
