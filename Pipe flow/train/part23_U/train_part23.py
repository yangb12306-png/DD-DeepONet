...
data_set_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_train_10100/data_10100_pipe.txt")
...
data_set_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/data_skewing_10032.txt")
...
label_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_train_10100/label_part23.txt")
label_train_01 = label_01[train_case_01, :]
label_test_01 = label_01[test_case_01, :]
label_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/label_part23.txt")
...
branch_2_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_train_10100/Dirichlet_1And2.txt")
branch_2_train_01 = branch_2_01[train_case_01, :]
branch_2_test_01 = branch_2_01[test_case_01, :]
branch_2_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/Dirichlet_1and2.txt")
...
branch_3_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_train_10100/Dirichlet_3And4.txt")
...
losshistory, train_state = model.train(iterations=500000, 
                                       batch_size = 64, 
                                       model_save_path='/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/part23_U/part_model')

# Plot the loss trajectory
dde.utils.plot_loss_history(losshistory)
plt.savefig('/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/part23_U/loss_curve.png')  
