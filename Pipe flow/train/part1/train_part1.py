...
label_U_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_train_10100/label_part1.txt")
label_U_train_01 = label_U_01[train_case_U_01, :]
label_U_test_01 = label_U_01[test_case_U_01, :]
label_Z_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_train_10100/label_part1.txt")
label_Z_train_01 = label_Z_01[train_case_Z_01, :]
label_Z_test_01 = label_Z_01[test_case_Z_01, :]
label_U_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/label_part1.txt")
label_U_train_skew = label_U_skew[train_case_U_skew, :]
label_U_test_skew = label_U_skew[test_case_U_skew, :]
label_Z_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_skewing/label_part1.txt")
...
branch_1_U_01 = [dx1_U_01 + dx2_U_01, 1 / (dx1_U_01 + dx2_U_01), 1 / (dx1_U_01 + dx2_U_01)**2, dy1_U_01, 1 / dy1_U_01, 1 / dy1_U_01**2]
...
branch_1_Z_01 = [dx1_Z_01 + dx2_Z_01, 1 / (dx1_Z_01 + dx2_Z_01), 1 / (dx1_Z_01 + dx2_Z_01)**2, dy1_Z_01, 1 / dy1_Z_01, 1 / dy1_Z_01**2]
...
branch_1_U_skew = [dx1_U_skew + dx2_U_skew, 1 / (dx1_U_skew + dx2_U_skew), 1 / (dx1_U_skew + dx2_U_skew)**2, dy1_U_skew, 1 / dy1_U_skew, 1 / dy1_U_skew**2]
...
branch_1_Z_skew = [dx1_Z_skew + dx2_Z_skew, 1 / (dx1_Z_skew + dx2_Z_skew), 1 / (dx1_Z_skew + dx2_Z_skew)**2, dy1_Z_skew, 1 / dy1_Z_skew, 1 / dy1_Z_skew**2]
...
inlet_vel_U_01 = inlet_vel_U_01.reshape(-1, 1)
branch_2_U_01 = np.tile(inlet_vel_U_01, (1, 40))
branch_2_train_U_01 = branch_2_U_01[train_case_U_01, :]
branch_2_test_U_01 = branch_2_U_01[test_case_U_01, :]
inlet_vel_Z_01 = inlet_vel_Z_01.reshape(-1, 1)
branch_2_Z_01 = np.tile(inlet_vel_Z_01, (1, 40))
branch_2_train_Z_01 = branch_2_Z_01[train_case_Z_01, :]
branch_2_test_Z_01 = branch_2_Z_01[test_case_Z_01, :]
branch_2_U_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/Dirichlet_inlet.txt")
branch_2_train_U_skew = branch_2_U_skew[train_case_U_skew, :]
branch_2_test_U_skew = branch_2_U_skew[test_case_U_skew, :]
branch_2_Z_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_skewing/Dirichlet_inlet.txt")
...
branch_3_U_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_train_10100/Dirichlet_1And2And3.txt")
branch_3_train_U_01 = branch_3_U_01[train_case_U_01, :]
branch_3_test_U_01 = branch_3_U_01[test_case_U_01, :]
branch_3_Z_01 = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_train_10100/Dirichlet_1and2and3_part1.txt")
branch_3_train_Z_01 = branch_3_Z_01[train_case_Z_01, :]
branch_3_test_Z_01 = branch_3_Z_01[test_case_Z_01, :]
branch_3_U_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_U_skewing/Dirichlet_1and2and3.txt")
branch_3_train_U_skew = branch_3_U_skew[train_case_U_skew, :]
branch_3_test_U_skew = branch_3_U_skew[test_case_U_skew, :]
branch_3_Z_skew = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/data_Z_skewing/Dirichlet_1and2and3_part1.txt")
...
branch_4_U_01 = dx2_U_01 / (dx1_U_01 + dx2_U_01)
branch_4_U_01 = branch_4_U_01.reshape(-1, 1)
branch_4_train_U_01 = branch_4_U_01[train_case_U_01, :]
branch_4_test_U_01 = branch_4_U_01[test_case_U_01, :]
branch_4_Z_01 = dx2_Z_01 / (dx1_Z_01 + dx2_Z_01)
branch_4_Z_01 = branch_4_Z_01.reshape(-1, 1)
branch_4_train_Z_01 = branch_4_Z_01[train_case_Z_01, :]
branch_4_test_Z_01 = branch_4_Z_01[test_case_Z_01, :]
branch_4_U_skew = dx2_U_skew / (dx1_U_skew + dx2_U_skew)
branch_4_U_skew = branch_4_U_skew.reshape(-1, 1)
branch_4_train_U_skew = branch_4_U_skew[train_case_U_skew, :]
branch_4_test_U_skew = branch_4_U_skew[test_case_U_skew, :]
branch_4_Z_skew = dx2_Z_skew / (dx1_Z_skew + dx2_Z_skew)
branch_4_Z_skew = branch_4_Z_skew.reshape(-1, 1)
branch_4_train_Z_skew = branch_4_Z_skew[train_case_Z_skew, :]
branch_4_test_Z_skew = branch_4_Z_skew[test_case_Z_skew, :]

branch_4_train = np.vstack((branch_4_train_U_01, branch_4_train_Z_01, branch_4_train_U_skew, branch_4_train_Z_skew))
branch_4_test = np.vstack((branch_4_test_U_01, branch_4_test_Z_01, branch_4_test_U_skew, branch_4_test_Z_skew))


trunk = np.loadtxt("/data2/project_share/yangbo/NS_pipe_DD_reorder/trunk_UZ/trunk_part1.txt") 
...
losshistory, train_state = model.train(iterations=500000, 
                                       batch_size = 64, 
                                       model_save_path='/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/part1/part_model')

# Plot the loss trajectory
dde.utils.plot_loss_history(losshistory)
plt.savefig('/data2/yangbo/NS_pipe_DD_reorder/train_UZ_40400/part1/loss_curve.png')  
